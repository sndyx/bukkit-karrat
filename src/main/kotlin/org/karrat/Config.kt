...
public object Config {
    ...
    private inline fun <T> latched(initializer: () -> T): ReadWriteProperty<Any?, T> =
    ...
    private fun <T> latched(property: ReadWriteProperty<Any?, T>): ReadWriteProperty<Any?, T> =
