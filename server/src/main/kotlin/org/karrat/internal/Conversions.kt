...
internal fun org.bukkit.entity.Entity.karrat(): Entity = TODO()
internal fun Entity.bukkit() = entity
...
internal fun org.bukkit.Material.karrat() = Material.fromIdentifier(key.karrat())
internal fun Material.bukkit() = org.bukkit.Material.values()
    .first { it.key.karrat() == identifier }

internal fun org.bukkit.block.Biome.karrat() = Biome.fromIdentifier(key.karrat())
internal fun Biome.bukkit() = org.bukkit.block.Biome.values()
    .first { it.key.karrat() == id }

internal fun org.bukkit.Chunk.karrat() = Chunk(this)

internal fun org.bukkit.NamespacedKey.karrat() = id(namespace, key)